...
<body class="p-4 max-w-md mx-auto pb-24">
    ...
    <header class="text-center py-10 relative">
        ...
        <h1 class="text-5xl font-black italic tracking-tighter mb-2 relative z-10">
            <span class="bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">NARUTO</span>
        </h1>
...
if __name__ == '__main__':
    ...
    print("🔥 NARUTO Master Hub Running...")
    print("="*50)
